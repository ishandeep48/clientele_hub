...
const Sales: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const getData = async()=>{
      const res=await axios.get('https://clientele-hub.onrender.com/admin/sales/all');
  ...
  const handleDeleteSale = async(id: string) => {
    console.log(id)
    const res = await axios.delete('https://clientele-hub.onrender.com/admin/sales/delete',{data:{id}});
    console.log(res);
