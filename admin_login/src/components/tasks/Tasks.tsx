...
const Tasks = () => {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      ...
      setError(null);
      try {
        const res = await axios.get('https://clientele-hub.onrender.com/admin/tasks/all');
  ...
  const deleteTask = async (task: any) => {
    ...
    try{
      await axios.delete('https://clientele-hub.onrender.com/admin/tasks/delete', { data: { title: task.title, dueDate: task.dueDate } });
      // refresh
      const res = await axios.get('https://clientele-hub.onrender.com/admin/tasks/all');
  ...
  const saveEdit = async () => {
    ...
    try{
      ...
      if(editingOriginal?.isTicket && editingOriginal?.ticketId){
        console.log(1111)
        await axios.put('https://clientele-hub.onrender.com/admin/tasks/update', {
